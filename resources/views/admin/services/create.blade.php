...
<div class="page-header">
    ...
    <a href="{{ route('admin.services.index') }}" class="btn btn-sm" style="border:1.5px solid #e2e8f0; font-size:13px; font-weight:600; color:#555; border-radius:8px; padding:8px 18px;">
    ...
    <div class="row g-4">
            ...
            <div class="form-card mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                           value="{{ old('title') }}" placeholder="e.g. MEA Attestation Services" required>
                    @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label class="form-label">Slug (URL) <span class="text-muted" style="font-weight:400;">(auto-generated if empty)</span></label>
                    <div class="input-group">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror"
                               value="{{ old('slug') }}" placeholder="mea-attestation-services" style="border-radius:0 8px 8px 0;">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror"
                              rows="2" placeholder="Brief description shown in service cards and listings..."
                              maxlength="500">{{ old('short_description') }}</textarea>
                    @error('short_description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-1">
                    <label class="form-label">Long Description <span class="text-muted" style="font-weight:400;">(full page content)</span></label>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card mb-4">
                ...
                <div class="mb-3">
                    <label class="form-label">Sort Order <span class="text-muted" style="font-weight:400;">(lower = first)</span></label>
                ...
                <div class="mb-1">
                    ...
                    <div style="font-size:11.5px; color:#8a99b0; margin-top:5px;">
                        <a href="https://fontawesome.com/icons" target="_blank" style="color:var(--gold);">Browse FA icons</a>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.services.index') }}" class="btn text-center" style="border:1.5px solid #e2e8f0; font-size:13.5px; border-radius:8px; padding:10px; font-weight:600; color:#555;">
                        Cancel
                    </a>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="mb-1">
                    <label class="form-label">Service Feature Image <span class="text-muted" style="font-weight:400;">JPG/PNG, max 2MB</span></label>
                    <input type="file" name="main_image" class="form-control @error('main_image') is-invalid @enderror"
                           accept="image/*" id="mainInput">
