    ...
    <div class="page-header">
        <div>
            ...
            <div class="page-breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a> / <a
                    href="{{ route('admin.pages.index') }}">Pages</a> / Edit</div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="form-card mb-4">
                    ...
                    <div class="mb-4 d-flex align-items-center justify-content-between p-3 rounded-2"
                    ...
                    <div class="mb-4">
                        ...
                        @if ($page->banner_image)
                            <div style="position:relative;margin-bottom:10px;">
                                <img src="{{ asset('storage/' . $page->banner_image) }}" alt=""
                                    style="width:100%;border-radius:8px;max-height:120px;object-fit:cover;"
                                    id="bannerPreview">
                                <div style="font-size:11.5px;color:#8a99b0;margin-top:4px;">Current banner image</div>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="delete_banner_image"
                                    value="1" id="deleteBannerImage">
                                <label class="form-check-label" for="deleteBannerImage">Delete current banner
                                    image</label>
                            </div>
                        @else
                            <img id="bannerPreview" src="" alt=""
                                style="display:none;margin-bottom:10px;width:100%;border-radius:8px;max-height:120px;object-fit:cover;">
                        @endif
                        <input type="file" name="banner_image" class="form-control" accept="image/*"
                            onchange="previewImg(this,'bannerPreview')">
                    </div>
                ...
                <div class="form-card" style="background:#f8fafc;">
                    ...
                    <div style="font-size:12.5px;color:#8a99b0;">
                        <div class="d-flex justify-content-between mb-2"><span>Created:</span><span
                                style="color:var(--primary);font-weight:600;">{{ $page->created_at->format('d M Y') }}</span>
                        </div>
                        <div class="d-flex justify-content-between"><span>Updated:</span><span
                                style="color:var(--primary);font-weight:600;">{{ $page->updated_at->format('d M Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
