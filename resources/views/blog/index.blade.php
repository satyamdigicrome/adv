...
@section('content')
    ...
    <section
        ...
        <div
            style="position:absolute;top:-80px;right:-80px;width:400px;height:400px;background:rgba(201,168,76,0.05);border-radius:50%;">
        </div>
        <div
            style="position:absolute;bottom:-120px;left:-60px;width:300px;height:300px;background:rgba(255,255,255,0.03);border-radius:50%;">
        </div>
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-7" data-aos="fade-right">
                    <span
                        style="display:inline-block;background:rgba(201,168,76,0.2);color:var(--gold);font-size:12px;font-weight:700;letter-spacing:2px;text-transform:uppercase;padding:6px 16px;border-radius:50px;border:1px solid rgba(201,168,76,0.3);margin-bottom:16px;">Knowledge
                        Hub</span>
                    <h1
                        style="font-size:clamp(32px,5vw,52px);font-weight:800;color:#fff;line-height:1.2;margin-bottom:16px;">
                    ...
                    <p style="font-size:16px;color:rgba(255,255,255,0.7);line-height:1.8;max-width:520px;">
                        Stay informed with the latest news, tips and guides on document attestation, apostille, embassy
                        processes and more.
                    </p>
                </div>
                <div class="col-lg-5 mt-4 mt-lg-0" data-aos="fade-left">
                    <div class="row g-3">
                        <div class="col-6">
                            <div
                                style="background:rgba(255,255,255,0.07);backdrop-filter:blur(10px);border-radius:16px;padding:20px;border:1px solid rgba(255,255,255,0.1);text-align:center;">
                                <div style="font-size:32px;font-weight:800;color:var(--gold);">
                                    {{ \App\Models\Blog::active()->published()->count() }}+</div>
                                <div style="font-size:12px;color:rgba(255,255,255,0.6);margin-top:4px;">Articles Published
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div
                                style="background:rgba(255,255,255,0.07);backdrop-filter:blur(10px);border-radius:16px;padding:20px;border:1px solid rgba(255,255,255,0.1);text-align:center;">
                                <div style="font-size:32px;font-weight:800;color:var(--gold);">{{ $categories->count() }}+
                                </div>
        ...
        <section style="background:#fff;padding:50px 0 0;">
            <div class="container">
                <div class="row g-0 align-items-stretch"
                    style="border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(15,32,68,0.12);border:1px solid #edf1f8;"
                    data-aos="fade-up">
                    ...
                    <div class="col-lg-6"
                        style="padding:44px 40px;display:flex;flex-direction:column;justify-content:center;">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <span
                                style="background:var(--gold);color:var(--primary);font-size:11px;font-weight:700;padding:4px 14px;border-radius:50px;text-transform:uppercase;letter-spacing:1px;">Featured</span>
                            <span
                                style="background:rgba(201,168,76,0.1);color:#a8893a;font-size:12px;font-weight:600;padding:4px 12px;border-radius:50px;">{{ $featured->category }}</span>
                        </div>
                        <h2
                            style="font-size:clamp(20px,3vw,28px);font-weight:800;color:var(--primary);line-height:1.3;margin-bottom:14px;">
                        ...
                        <p style="font-size:15px;color:#637082;line-height:1.8;margin-bottom:22px;">
                            {{ Str::limit($featured->short_description, 180) }}</p>
                        <div class="d-flex align-items-center gap-4 mb-4" style="font-size:13px;color:#8a99b0;">
                            ...
                            <span><i class="fas fa-calendar me-1" style="color:var(--gold);"></i>
                                {{ $featured->published_at->format('d M Y') }}</span>
                            <span><i class="fas fa-clock me-1" style="color:var(--gold);"></i>
                                {{ $featured->reading_time }}</span>
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 style="font-size:20px;font-weight:700;color:var(--primary);margin:0;">
                            Latest Articles
                            <span
                                style="font-size:13px;font-weight:500;color:#8a99b0;margin-left:8px;">({{ $blogs->total() }}
                                posts)</span>
                        </h3>
                    </div>
                    ...
                    @forelse($blogs as $blog)
                        <article
                            style="background:#fff;border-radius:18px;overflow:hidden;border:1.5px solid #edf1f8;box-shadow:0 4px 20px rgba(15,32,68,0.05);margin-bottom:28px;display:flex;flex-direction:column;transition:all 0.3s;"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8"
                                    style="padding:28px 28px 28px 24px;display:flex;flex-direction:column;">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        <span
                                            style="background:rgba(201,168,76,0.12);color:#a8893a;font-size:11px;font-weight:700;padding:3px 10px;border-radius:50px;">{{ $blog->category }}</span>
                                        <span style="font-size:12px;color:#8a99b0;"><i
                                                class="fas fa-clock me-1"></i>{{ $blog->reading_time }}</span>
                                    </div>
                                    <h4
                                        style="font-size:17px;font-weight:700;color:var(--primary);line-height:1.4;margin-bottom:10px;flex:1;">
                                    ...
                                    <p style="font-size:13.5px;color:#637082;line-height:1.7;margin-bottom:16px;">
                                        {{ Str::limit($blog->short_description, 120) }}</p>
                    ...
                    @empty
                        <div
                            style="text-align:center;padding:80px 20px;background:#fff;border-radius:18px;border:1.5px solid #edf1f8;">
                ...
                <div class="col-lg-4">
                    ...
                    @if ($categories->isNotEmpty())
                        <div
                            style="background:#fff;border-radius:16px;padding:28px;border:1.5px solid #edf1f8;box-shadow:0 4px 20px rgba(15,32,68,0.05);margin-bottom:28px;">
                            <h5
                                style="font-size:16px;font-weight:700;color:var(--primary);margin-bottom:18px;padding-bottom:12px;border-bottom:1px solid #f0f3f8;">
                                ...
                                <a href="{{ route('blog') }}?category={{ urlencode($cat->category) }}"
                                    ...
                                    <span style="font-size:13.5px;font-weight:600;color:var(--primary);">
                                        <i class="fas fa-chevron-right me-2"
                                            style="color:var(--gold);font-size:10px;"></i>{{ $cat->category }}
                                    </span>
                                    <span
                                        style="background:rgba(201,168,76,0.12);color:#a8893a;font-size:11px;font-weight:700;padding:2px 9px;border-radius:50px;">{{ $cat->count }}</span>
                                </a>
                            @endforeach
                        </div>
                    @endif
                        ...
                        <div
                            ...
                            @foreach ($recent as $r)
                                <a href="{{ route('blog.show', $r->slug) }}"
                                    style="display:flex;gap:12px;padding:10px 0;border-bottom:1px solid #f8fafc;text-decoration:none;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:11px;color:#8a99b0;margin-top:4px;"><i
                                                class="fas fa-calendar me-1"></i>{{ $r->published_at->format('d M Y') }}
                                        </div>
                                    </div>
                                </a>
                            @endforeach
                    ...
                    <!-- CTA -->
                    <div
                        style="background:linear-gradient(135deg,var(--primary),#1a3460);border-radius:16px;padding:28px;text-align:center;">
                        <i class="fas fa-file-alt"
                            style="font-size:36px;color:var(--gold);margin-bottom:14px;display:block;"></i>
                        <h5 style="color:#fff;font-size:17px;font-weight:700;margin-bottom:10px;">Need Attestation Help?
                        </h5>
                        <p style="color:rgba(255,255,255,0.7);font-size:13px;line-height:1.7;margin-bottom:20px;">Our
                            experts are ready to help you with all document attestation requirements.</p>
