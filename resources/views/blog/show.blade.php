...
@section('content')
    ...
    <!-- ============ HERO ============ -->
    <section
        style="background:linear-gradient(135deg,#0f2044 0%,#1a3460 100%);padding:70px 0 50px;position:relative;overflow:hidden;">
        <div style="position:absolute;inset:0;background:url('{{ $blog->image_url }}') center/cover no-repeat;opacity:0.08;">
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="d-flex align-items-center justify-content-center gap-3 mb-4" data-aos="fade-down">
                        ...
                        <span
                            style="background:rgba(201,168,76,0.2);color:var(--gold);font-size:12px;font-weight:700;padding:4px 14px;border-radius:50px;border:1px solid rgba(201,168,76,0.3);">{{ $blog->category }}</span>
                    </div>
                    <h1 style="font-size:clamp(26px,4.5vw,44px);font-weight:800;color:#fff;line-height:1.3;margin-bottom:20px;"
                        data-aos="fade-up">
                        {{ $blog->title }}
                    </h1>
                    <div class="d-flex align-items-center justify-content-center gap-4 flex-wrap"
                        style="font-size:13px;color:rgba(255,255,255,0.65);" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Featured Image -->
                    <div style="border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(15,32,68,0.12);margin-bottom:44px;"
                        data-aos="fade-up">
                    ...
                    <!-- Content -->
                    <div style="background:#fff;border-radius:20px;padding:44px 40px;box-shadow:0 4px 20px rgba(15,32,68,0.05);border:1.5px solid #edf1f8;"
                        data-aos="fade-up">
                        @if ($blog->short_description)
                            <div
                                style="background:rgba(201,168,76,0.08);border-left:4px solid var(--gold);border-radius:0 10px 10px 0;padding:18px 22px;margin-bottom:32px;">
                                <p
                                    style="font-size:16px;color:#4a5568;line-height:1.8;font-style:italic;margin:0;font-weight:500;">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center gap-3">
                                        <div
                                            style="width:52px;height:52px;background:linear-gradient(135deg,var(--primary),#1a3460);border-radius:50%;display:flex;align-items:center;justify-content:center;color:var(--gold);font-weight:800;font-size:18px;flex-shrink:0;">
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    <div class="d-flex align-items-center gap-2 justify-content-md-end flex-wrap">
                                        ...
                                        <button onclick="copyLink()"
                                            style="width:36px;height:36px;background:#e2e8f0;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#555;border:none;cursor:pointer;font-size:14px;"
                                            title="Copy Link">
                    ...
                    @if ($related->isNotEmpty())
                        <div style="margin-top:50px;">
                            <h3 style="font-size:22px;font-weight:800;color:var(--primary);margin-bottom:28px;">Related
                                Articles</h3>
                            <div class="row g-4">
                                @foreach ($related as $rel)
                                    <div class="col-md-4">
                                        <article
                                            style="background:#fff;border-radius:16px;overflow:hidden;border:1.5px solid #edf1f8;box-shadow:0 4px 16px rgba(15,32,68,0.06);height:100%;display:flex;flex-direction:column;transition:all 0.3s;"
                                            ...
                                            <div style="padding:18px;flex:1;display:flex;flex-direction:column;">
                                                <span
                                                    style="background:rgba(201,168,76,0.12);color:#a8893a;font-size:10px;font-weight:700;padding:2px 8px;border-radius:50px;width:fit-content;margin-bottom:8px;">{{ $rel->category }}</span>
                                                <h5
                                                    style="font-size:13.5px;font-weight:700;color:var(--primary);line-height:1.4;margin-bottom:12px;flex:1;">
                                                ...
                                                <div style="font-size:11.5px;color:#8a99b0;"><i
                ...
                <div class="col-lg-4">
                    ...
                    <!-- CTA -->
                    <div
                        style="background:linear-gradient(135deg,var(--primary),#1a3460);border-radius:16px;padding:28px;text-align:center;margin-bottom:28px;position:sticky;top:20px;">
                        <i class="fas fa-certificate"
                            style="font-size:38px;color:var(--gold);margin-bottom:14px;display:block;"></i>
                        <h5 style="color:#fff;font-size:17px;font-weight:700;margin-bottom:10px;">Need Document Attestation?
                        </h5>
                        <p style="color:rgba(255,255,255,0.7);font-size:13px;line-height:1.7;margin-bottom:20px;">Get expert
                            help for MEA, Embassy, Apostille & more. Fast turnaround guaranteed.</p>
                    ...
                    <div
                        style="background:#fff;border-radius:16px;padding:28px;border:1.5px solid #edf1f8;box-shadow:0 4px 20px rgba(15,32,68,0.05);">
                        <h5
                            style="font-size:16px;font-weight:700;color:var(--primary);margin-bottom:18px;padding-bottom:12px;border-bottom:1px solid #f0f3f8;">
