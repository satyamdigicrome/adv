...
<div style="background:linear-gradient(135deg,#0f2044 0%,#1a3460 100%);min-height:480px;display:flex;align-items:center;position:relative;overflow:hidden;">
    <!-- Background texture -->
    <div style="position:absolute;inset:0;opacity:0.03;background-image:url('data:image/svg+xml,%3Csvg width=%2260%22 height=%2260%22 viewBox=%220 0 60 60%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg fill=%22none%22 fill-rule=%22evenodd%22%3E%3Cg fill=%22%23ffffff%22 fill-opacity=%221%22%3E%3Cpath d=%22M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E');pointer-events:none;"></div>

    <div style="position:absolute;bottom:-60px;left:-60px;width:300px;height:300px;border-radius:50%;background:rgba(201,168,76,0.05);pointer-events:none;"></div>
    ...
    <div class="container position-relative" style="padding:80px 12px;">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <nav style="margin-bottom:20px;">
                    <ol style="list-style:none;padding:0;margin:0;display:flex;flex-wrap:wrap;gap:8px;font-size:12.5px;color:rgba(255,255,255,0.5);">
                        ...
                        <li><a href="{{ route('services') }}" style="color:rgba(255,255,255,0.5);text-decoration:none;" onmouseover="this.style.color='var(--gold)'" onmouseout="this.style.color='rgba(255,255,255,0.5)'">Services</a></li>
                        <li style="margin:0 4px;">/</li>
                ...
                <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(201,168,76,0.12);border:1px solid rgba(201,168,76,0.25);border-radius:50px;padding:6px 16px;margin-bottom:16px;">
                    ...
                    <span style="color:var(--gold);font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;">Our Services</span>
                </div>

                <h1 style="font-family:'Playfair Display',serif;color:#fff;font-size:clamp(28px,5vw,46px);font-weight:700;line-height:1.2;margin-bottom:16px;">
                    {{ $service->title }}
                </h1>

                @if($service->short_description)
                <p style="color:rgba(255,255,255,0.72);font-size:15px;line-height:1.8;max-width:520px;margin-bottom:28px;">
                ...
                <div style="display:flex;gap:20px;margin-top:28px;flex-wrap:wrap;">
                    ...
                    <div style="display:flex;align-items:center;gap:6px;">
                        ...
                        <span style="font-size:12.5px;color:rgba(255,255,255,0.65);font-weight:500;">{{ $b }}</span>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-lg-6 d-none d-lg-block" data-aos="fade-left" data-aos-delay="100">
                ...
                @else
                <div style="width:100%;height:300px;background:rgba(255,255,255,0.04);border-radius:20px;border:1px dashed rgba(255,255,255,0.12);display:flex;align-items:center;justify-content:center;">
                    <div style="text-align:center;">
                        <i class="{{ $service->icon ?? 'fas fa-file-alt' }}" style="font-size:64px;color:var(--gold);opacity:0.4;display:block;margin-bottom:16px;"></i>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-8" data-aos="fade-right">
                ...
                <div class="service-content" style="background:#fff;border-radius:16px;padding:36px;box-shadow:0 2px 20px rgba(15,32,68,0.06);border:1px solid #edf1f8;margin-bottom:32px;font-size:15.5px;line-height:1.9;color:#3d4a5c;">
                ...
                <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 2px 20px rgba(15,32,68,0.06);border:1px solid #edf1f8;margin-bottom:32px;">
                    <h3 style="font-family:'Playfair Display',serif;font-size:22px;font-weight:700;color:var(--primary);margin-bottom:20px;">
                        <span style="border-bottom:3px solid var(--gold);padding-bottom:4px;">Why Choose S K Document Centre?</span>
                    </h3>
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <div style="display:flex;align-items:center;gap:10px;padding:12px;border-radius:10px;background:#f8fafc;">
                                <div style="width:32px;height:32px;background:rgba(201,168,76,0.1);border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                    <i class="fas fa-check" style="color:var(--gold);font-size:12px;"></i>
                                </div>
                                <span style="font-size:13.5px;font-weight:600;color:var(--primary);">{{ $point }}</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <!-- Enquire Now Form -->
                <div id="enquire" style="background:var(--primary);border-radius:18px;padding:28px;margin-bottom:24px;position:sticky;top:80px;" data-aos="fade-left">
                ...
                <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 2px 16px rgba(15,32,68,0.06);border:1px solid #edf1f8;margin-bottom:24px;">
                    ...
                    <a href="{{ route('services.show', $svc->slug) }}"
                       ...
                       onmouseover="this.style.paddingLeft='6px'" onmouseout="this.style.paddingLeft='0'">
                        <div style="width:38px;height:38px;background:{{ $svc->id === $service->id ? 'var(--primary)' : 'rgba(15,32,68,0.06)' }};border-radius:9px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <i class="{{ $svc->icon ?? 'fas fa-file-alt' }}" style="color:{{ $svc->id === $service->id ? 'var(--gold)' : 'var(--primary)' }};font-size:14px;"></i>
                        </div>
                        <span style="font-size:13px;font-weight:600;color:var(--primary);line-height:1.3;flex:1;">{{ $svc->title }}</span>
                ...
                <div style="background:#f8fafc;border-radius:14px;padding:20px;border:1px solid #edf1f8;">
                    ...
                    <a href="tel:+919310624082" style="display:flex;align-items:center;gap:10px;text-decoration:none;margin-bottom:10px;">
                        <i class="fas fa-phone" style="color:var(--primary);font-size:14px;"></i>
                        <span style="font-size:13.5px;font-weight:600;color:var(--primary);">+91-9310624082</span>
                    </a>
                    <a href="https://wa.me/919310624082" target="_blank" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
...
@push('styles')
<style>
.service-content h1,.service-content h2,.service-content h3{color:var(--primary);font-weight:700;margin-top:28px;margin-bottom:14px;}
.service-content h2{font-size:22px;}.service-content h3{font-size:18px;}
.service-content ul,.service-content ol{padding-left:22px;margin-bottom:18px;}
.service-content ul li,.service-content ol li{margin-bottom:8px;}
.service-content table{width:100%;border-collapse:collapse;margin:20px 0;}
.service-content table th{background:var(--primary);color:#fff;padding:12px 16px;text-align:left;font-size:14px;}
.service-content table td{padding:10px 16px;border-bottom:1px solid #edf1f8;font-size:14px;}
.service-content blockquote{border-left:4px solid var(--gold);padding:14px 20px;background:#f8fafc;border-radius:0 8px 8px 0;margin:20px 0;color:#637082;font-style:italic;}
.service-content img{max-width:100%;border-radius:8px;margin:10px 0;}
#enquire input::placeholder,#enquire textarea::placeholder{color:rgba(255,255,255,0.35);}
