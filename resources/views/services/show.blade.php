...
@section('content')
    ...
    <div
        ...
        <!-- Background texture -->
        <div
            style="position:absolute;inset:0;background-size:cover;background-position:center;opacity:0.2;background-image:url('{{ asset('storage/' . $service->banner_image) }}');pointer-events:none;">
        </div>
