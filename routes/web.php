...
Route::get('/attestation-process', function () {
    return view('attestation-process');
})->name('attestation.process');
...
Route::prefix('admin')->name('admin.')->middleware('admin.auth')->group(function () {
    ...
    // Tied up companies CRUD
    Route::get('/tied-up-companies', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'index'])->name('tied-up-companies.index');
    Route::get('/tied-up-companies/create', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'create'])->name('tied-up-companies.create');
    Route::post('/tied-up-companies', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'store'])->name('tied-up-companies.store');
    Route::get('/tied-up-companies/{tiedUpCompany}/edit', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'edit'])->name('tied-up-companies.edit');
    Route::put('/tied-up-companies/{tiedUpCompany}', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'update'])->name('tied-up-companies.update');
    Route::delete('/tied-up-companies/{tiedUpCompany}', [\App\Http\Controllers\Admin\TiedUpCompanyController::class, 'destroy'])->name('tied-up-companies.destroy');
